...
def test_fetch_info():
    ...
    with patch("unesco_reader.uis.UISInfoScraper.get_links") as mock_get_links:
        ...
        # basic functionality
        mock_get_links.return_value = [{'theme': 'Education', 'name': 'Test Data', 'latest_update': 'January 2022', 'href': 'test.zip'}]
        ...
        mock_get_links.return_value = [{'theme': 'Science', 'name': 'New Data', 'latest_update': 'February 2022', 'href': 'new_test.zip'}]
        new_expected = [{'theme': 'Science', 'name': 'New Data', 'latest_update': 'February 2022', 'href': 'new_test.zip'}]
...
def test_fetch_data():
    ...
    with patch("unesco_reader.uis.get_zipfile") as mock_get_zipfile:
        ...
        # Create a CSV string
        csv_str = 'indicator_id,country_id,year,value,magnitude,qualifier\nind1,1,2020,10,,'
        ...
        # Test cache refresh and new data
        new_csv_str = 'indicator_id,country_id,year,value,magnitude,qualifier\nind2,2,2021,20,,'
...
def test_fetch_dataset_info():
    ...
    with patch("unesco_reader.uis.fetch_info") as mock_fetch_info:
        ...
        mock_fetch_info.return_value = [
            {'theme': 'Education', 'name': 'dataset_1', 'latest_update': 'January 2022', 'href': 'test.zip'},
            {'theme': 'Science', 'name': 'dataset_2', 'latest_update': 'February 2022', 'href': 'new_test.zip'}
        ]
...
def test_info(capsys):
    ...
    with patch("unesco_reader.uis.fetch_info") as mock_fetch_info:
        ...
        mock_fetch_info.return_value = [
            {'theme': 'Education', 'name': 'Test Data', 'latest_update': 'January 2022', 'href': 'test.zip'}
        ]
        ...
        expected_output = "theme      name       latest_update\n" \
                          "---------  ---------  ---------------\n" \
...
class TestUIS:
    ...
    def test_init(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        mock_fetch_dataset_info.return_value = {'theme': 'Education', 'name': 'Test Data', 'latest_update': 'January 2022', 'href': 'test.zip'}
        ...
        assert obj._dataset_info == {'theme': 'Education', 'name': 'Test Data', 'latest_update': 'January 2022', 'href': 'test.zip'}
    ...
    def test_refresh(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        mock_fetch_dataset_info.return_value = {'theme': 'Education', 'name': 'Test Data', 'latest_update': 'February 2022', 'href': 'test.zip'}
        ...
        assert obj._dataset_info == {'theme': 'Education', 'name': 'Test Data', 'latest_update': 'February 2022', 'href': 'test.zip'}
    ...
    def test_get_country_data(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        with pytest.raises(ValueError, match="Regional data is not available for this dataset."):
    ...
    def test_get_metadata(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        obj = uis.UIS('Test Data')
        with pytest.raises(ValueError, match="Metadata is not available for this dataset."):
            obj.get_metadata()
    ...
    def test_get_countries(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        with pytest.raises(ValueError, match="Information about countries is not available for this dataset."):
            obj.get_countries()
    ...
    def test_get_regions(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        mock_uis_data.region_concordance = None
        with pytest.raises(ValueError, match="Information about regions is not available for this dataset."):
            obj.get_regions()
    ...
    def test_get_variables(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        with pytest.raises(ValueError, match="Information about variables is not available for this dataset."):
            obj.get_variables()
    ...
    def test_readme(self, mock_fetch_data, mock_fetch_dataset_info):
        ...
        with pytest.raises(ValueError, match="Readme file is not available for this dataset."):
            _ = obj.readme
