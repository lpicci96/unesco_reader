...
class TestLinkScraper:
    ...
    def test_get_soup(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            soup = read.LinkScraper.get_soup()
    ...
    def test_parse_link_section(self):
        ...
        result = read.LinkScraper.parse_link_section(link_section)
    ...
    def test_parse_link_text(self):
        ...
        result = read.LinkScraper.parse_link_text(link_text)
    ...
    def test_get_links(self):
        """Test get_links"""
        with patch.object(read.LinkScraper, 'get_soup') as mock_get_soup:
            mock_get_soup.return_value = BeautifulSoup(
                ...
                'html.parser')
            result = read.LinkScraper.get_links()
